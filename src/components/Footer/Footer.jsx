...
const Footer = () => {
    ...
    const socialIcons = [FaFacebook, FaInstagram, FaLinkedin];
          ...
          <div className=" py-8 px-4 ">
            ...
            <div className="flex items-center h-10">
              <input
                ...
                placeholder="Email"
              />
              <button className="bg-orange-500 hover:bg-orange-500/75 h-full border-2 inline-block py-2 px-6 text-white">
                Ok
              </button>
            </div>
          </div>
        ...
        <div className="hidden sm:block">
          <div className="flex justify-between items-center text-center py-6 border-t-2 border-gray-300/40">
            <span className="text-sm text-gray-400">
              @copyright 2024 Space-x || Ruchika
            </span>
            <div className="flex items-center justify-center gap-4 mb-4">
              {
                socialIcons.map((ICON,index) => (
                    <ICON className="text-2xl cursor-pointer" key={index}/>
                ))
              }
            </div>
